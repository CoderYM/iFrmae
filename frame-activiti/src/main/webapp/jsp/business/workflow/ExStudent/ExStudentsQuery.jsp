...
<form id="pagerForm" method="post" action="activitiTest" onsubmit="return navTabSearch(this)">
	...
	<div class="pageHeader">
		<div class="searchBar">
				...
				<li>
					<label>姓名：</label> 
					<input type="text" name="name" value="${exStudent.name}" />
				</li>
			   	 
			  	<li>
			  		<label>生日：</label>
	      			<input type="text" name="birthday" value="${exStudent.birthday}"  class="date" dateFmt="yyyy-MM-dd HH:mm:ss" readonly="true" />
	      			<a class="inputDateButton" href="#">选择</a>
				</li>
			   	 
				<li>
					<label>姓别：</label> 
					<input type="text" name="sex" value="${exStudent.sex}" />
				</li>
			   	 	</ul>
			   	 	<ul class="searchContent">
				...
				<li>
					<label>描述：</label> 
					<input type="text" name="desc" value="${exStudent.desc}" />
				</li>
			</ul>
			<div class="subBar">
				<ul>
	...
	<div class="panelBar">
		<ul class="toolBar">
			<li><a class="add" target="navTab" rel="activitiTestNav"
				href="activitiTest/addExStudentToPage" title="添加"><span>添加</span></a></li>
			...
			<li><a class="add" target="ajaxTodo"  href="activitiTest/workflowTest"><span>activiti测试</span></a></li>
