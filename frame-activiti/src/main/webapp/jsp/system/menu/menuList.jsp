...
<div class="pageContent">
	...
	<table class="list" width="100%" layoutH="138" targetType="navTab" asc="asc" desc="desc">
		<thead>
			<tr>
				...
				<th orderField="sys_menu_name" class="desc">菜单名</th>
				<th orderField="sys_menu_url" class="asc">菜单链接</th>
				<th>菜单编码</th>
				<th>菜单描述</th>
				<th>状态</th>
				<th>备注</th>
