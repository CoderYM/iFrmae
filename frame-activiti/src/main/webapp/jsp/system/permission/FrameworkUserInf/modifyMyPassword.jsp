...
<form method="post" action="sysuser/modifyMyPassword" class="pageForm required-validate" onsubmit="return validateCallback(this,dialogAjaxDone);">
	...
	<div class="pageFormContent" layoutH="56">
	 	<dl>
			...
			<dl>
				<dt>原始密码:</dt>
				<dd>
					<input type="password" name="oriUserPassword"
