...
<div class="pageContent">
	<form method="post"
		action="permission/modifyFrameworkSysPermissionAction?rel=page_menu_list&callbackType=closeCurrent"
		...
		<div class="pageFormContent" layoutH="56">
			...
			<p>
				<label>权限描述</label>
				<textarea style="width: 50%; height: 100px" name="permissionDescription" maxlength="200">${infos.permissionDescription}</textarea>
			</p>
		</div>
