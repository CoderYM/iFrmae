...
_switchTabByName: function(tabName){
var iTabIndex = 0;this._getTabs().each(function(i){if($(this).filter("li").attr('tabid')==tabName) iTabIndex = i});this._switchTab(iTabIndex);},
_getPanels:function(){
...
var newArgs=_.uniq(args, false , function(item) {return item.name;});
$panel.loadUrl(url,newArgs,function(){navTab._loadUrlCallback($panel);});}}},
...
if(json.navTabId && json.rel){
var $pagerForm=$("#pagerForm",$("#"+json.rel));var args=$pagerForm.size()>0?$pagerForm.serializeArray():{}
navTabPageBreak(args,json.rel); divSearch($pagerForm,json.rel);
}else{ 
if(json.navTabId){
...
if(json.navTabId && json.rel){navTab.closeCurrentTab();navTab._switchTabByName(json.navTabId);}else setTimeout(function(){navTab.closeCurrentTab(json.navTabId);},100);}else if("forward"==json.callbackType){
...
$.pdialog.closeCurrent();
if(args_1){if(typeof args_1 == "function"){args_1(args);}}}});
$.fn.extend({
lookup:function(){
return this.each(function(){
